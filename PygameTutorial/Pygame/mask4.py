...
# ship setup
ship_surf = pygame.image.load('Pygame2023/PygameTutorial/pygame/ship.png').convert_alpha()
ship_rect = ship_surf.get_rect(center = (300,300))
ship_mask = pygame.mask.from_surface(ship_surf)

# obstable setup
obstacle_surf = pygame.image.load('Pygame2023/PygameTutorial/pygame/alpha.png').convert_alpha()
